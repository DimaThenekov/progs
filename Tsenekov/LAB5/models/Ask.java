...
public class Ask {
	...
	public static Dragon askDragon(Console console, CollectionManager collectionManager) throws AskBreak {
		/*
		...
		*/
		try {
			...
			return new Dragon(collectionManager.getFreeId(), name, coordinates, age, color, type, character, killer);
